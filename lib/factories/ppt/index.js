...
class PptFactory {
    ...
    addConnector(slide, connector) {
        return this.slideFactory.addConnector(slide, connector, connector.options);
    }
    ...
    addImage(slide, image) {
        ...
        if(image.name()) mediaName = image.name();
    ...
    editShape(shape) {
        return this.slideFactory.editShape(shape);
    }
    ...
    copyShape({ slide, shape, shapeCopyName }) {
        return this.slideFactory.copyShape({ slide, shape, shapeCopyName });
    }
