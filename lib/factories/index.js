...
class PowerPointFactory {
    ...
    addConnector(slide, connector) {
        connector.setContent(this.pptFactory.addConnector(slide, connector));
    }
    ...
    editShape(shape) {
        shape.setContent(this.pptFactory.editShape(shape));
    }
    ...
    copyShape({ slide, shape, shapeCopy, shapeCopyName }) {
        shapeCopy.setContent(this.pptFactory.copyShape({ slide, shape, shapeCopyName }));
    }
